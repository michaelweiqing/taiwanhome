...
const DISTRICTS: Record<string, { zh: string; vi: string }[]> = {
  ...
  "新北市": [
    ...
    {zh:"汐止區",vi:"Uông Chỉ"},{zh:"鶯歌區",vi:"Oanh Ca"},{zh:"三峽區",vi:"Tam Hiệp"},
  ...
  "桃園市": [
    ...
    {zh:"龜山區",vi:"Quy Sơn"},{zh:"大溪區",vi:"Đại Khê"},{zh:"大園區",vi:"Đại Viên"},
    {zh:"觀音區",vi:"Quan Âm"},
  ],
  ...
  "台南市": [
    {zh:"東區",vi:"Khu Đông"},{zh:"西區",vi:"Khu Tây"},{zh:"南區",vi:"Khu Nam"},
    {zh:"北區",vi:"Khu Bắc"},{zh:"安平區",vi:"An Bình"},{zh:"安南區",vi:"An Nam"},
    {zh:"永康區",vi:"Vĩnh Khang"},{zh:"仁德區",vi:"Nhân Đức"},{zh:"歸仁區",vi:"Quy Nhân"},
    {zh:"新化區",vi:"Tân Hóa"},{zh:"善化區",vi:"Thiện Hóa"},{zh:"麻豆區",vi:"Ma Đậu"},
  ],
  "高雄市": [
    {zh:"三民區",vi:"Tam Dân"},{zh:"苓雅區",vi:"Linh Nhã"},{zh:"前鎮區",vi:"Tiền Trấn"},
    {zh:"鼓山區",vi:"Cổ Sơn"},{zh:"左營區",vi:"Tả Doanh"},{zh:"楠梓區",vi:"Nam Tử"},
    {zh:"鳳山區",vi:"Phụng Sơn"},{zh:"仁武區",vi:"Nhân Vũ"},{zh:"大社區",vi:"Đại Xã"},
    {zh:"岡山區",vi:"Cương Sơn"},{zh:"路竹區",vi:"Lộ Trúc"},{zh:"旗山區",vi:"Kỳ Sơn"},
  ],
}
