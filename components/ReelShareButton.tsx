  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="flex items-center justify-center w-9 h-9 rounded-full overflow-hidden shadow-md shadow-orange-900/30 active:scale-95 transition"
      >
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img src="/icons/reel-share.png" alt="" width={36} height={36} className="w-full h-full object-cover" />
      </button>
