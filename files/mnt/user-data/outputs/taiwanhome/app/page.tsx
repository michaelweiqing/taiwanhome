...
export default function HomePage() {
  ...
  return (
    <div>
      {/* Hero */}
      <div className="bg-gradient-to-br from-red-700 via-red-600 to-red-500 py-12 px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <div className="flex bg-white rounded-2xl overflow-hidden shadow-xl max-w-lg mx-auto">
            <select className="border-r border-gray-100 px-3 py-3.5 text-sm text-gray-700 bg-white focus:outline-none">
            ...
            <Link href="/listings"
              className="bg-red-600 hover:bg-red-700 text-white px-5 py-3.5 text-sm font-semibold transition">
              {lang === "zh" ? "搜尋" : "Tìm"}
            </Link>
          </div>
        </div>
      ...
      <div className="max-w-6xl mx-auto px-4 py-10 space-y-12">
        ...
        <section>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
            {[
              { city: "台北市", vi: "Đài Bắc", emoji: "🏙️", n: 5234 },
              { city: "台中市", vi: "Đài Trung", emoji: "🌆", n: 3891 },
              { city: "高雄市", vi: "Cao Hùng",  emoji: "🌊", n: 2710 },
              { city: "台南市", vi: "Đài Nam",   emoji: "🏯", n: 1482 },
            ].map(c => (
              <Link key={c.city} href={`/listings?city=${c.city}`}
                className="bg-white border border-gray-200 rounded-2xl p-4 text-center
                           hover:border-red-400 hover:shadow-sm transition">
